...
chdir($lstm_d);
my $data_d = "/home/jibmaird/Data/Experiments/Mutation/6/conll_residual";

#system("python train.py --train=$data_d\/train.tsv --dev=$data_d\/devel.tsv --test=$data_d\/test.tsv > $data_d/log.txt");

my $result_f = "/home/jibmaird/Projects/ADE/EntityExtraction/Tools/residual-lstm/evaluation/temp/eval.1234194.output";
