...
my $NER_DIR = "$h/Data/Experiments/Mutation/18/bio";
my $OUT_DIR = "$h/Data/Experiments/Mutation/18/bert_out";
...
system("perl ./biocodes/conlleval.pl < $OUT_DIR/NER_result_conll.txt > $OUT_DIR/eval_entity.txt");
