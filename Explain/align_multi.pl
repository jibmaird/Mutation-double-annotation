...
my $train_d = "/aitu-stor/dmiraola/Experiments/Mutation/1/Train-sent";
...
while(<I1>) {
    chomp;
    my $err_sent = $_;
    my $tmp_f1 = "/aitu-stor/dmiraola/Experiments/Mutation/1/target_sent.txt";
    my $tmp_f2 = "/aitu-stor/dmiraola/Experiments/Mutation/1/target_sent2.txt";
    my $id = <I2>;
    chomp($id);
